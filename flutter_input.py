...
"""
imports and preprocesses accelerometer data
"""
...
def import_csv_acc(filename, data_format):
    ...
    if data_format == 0:
        ...
        acc_data_cleaned = np.char.strip(acc_data_raw, "\"") # remove leading and trailing quotation marks if present
        ...
        time_conv = convert_times(time_basis, time_format) # convert time from string to float
...
"""
checks which format the time string in the csv is in
returns time format
"""
